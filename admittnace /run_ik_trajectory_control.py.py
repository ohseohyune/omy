...
from trajectory_generator import generate_trajectory  # Trajectory 생성기 (이미 작성하신 것)
...
ee_frame_name = "link6"  # ✅ 당신의 엔드이펙터 링크 이름으로 수정
